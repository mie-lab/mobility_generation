"""
Original implementation from Multi-Task Learning as Multi-Objective Optimization, taken from:
...
class MinNormSolver:
    ...
    def _next_point(cur_val, grad, n):
        if type(cur_val) is torch.Tensor:
    ...
    def find_min_norm_element(vecs):
        ...
        while iter_count < MinNormSolver.MAX_ITER:
            ...
            if type(change) is torch.Tensor:
                change = change.numpy()
